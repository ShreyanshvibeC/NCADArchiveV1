<template>
  <div class="min-h-screen bg-black p-4">
    ...
    <header class="flex items-center justify-between mb-8 bg-black p-4 -m-4 mb-8">
      ...
      <h1 class="text-xl font-semibold flex items-center">Upload Photo</h1>
      <div class="w-6"></div>
    </header>
    ...
    <div class="max-w-md mx-auto lg:max-w-lg xl:max-w-xl">
      ...
      <div v-if="!authStore.isAuthenticated" class="text-center py-12">
        ...
        <div class="space-y-3">
          <router-link 
            to="/login" 
            class="block bg-ncad-green text-black px-6 py-3 font-medium hover:bg-opacity-80 transition-all"
          >
            Sign In
          </router-link>
          <router-link 
