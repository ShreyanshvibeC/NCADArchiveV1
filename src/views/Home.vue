<template>
  <div class="min-h-screen bg-black">
    ...
    <div v-if="initialImagesLoaded">
      ...
      <!-- Floating CTA Button with Rainbow Glow -->
      <button 
        @click="handleUploadClick"
        class="cta-rainbow-glow fixed bottom-6 left-6 w-20 h-20 bg-black border-2 border-white text-white flex items-center justify-center hover:bg-gray-900 transition-all z-40 shadow-lg"
      >
