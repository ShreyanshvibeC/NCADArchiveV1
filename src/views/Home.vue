<template>
  <div class="min-h-screen bg-black">
    ...
    <div v-else>
      ...
      <!-- Floating Add Button - Black with white border and white + -->
<button 
  @click="handleUploadClick"
  class="fixed bottom-6 left-6 w-20 h-20 text-white text-4xl font-medium flex items-center justify-center z-40 shadow-lg 
         group transition-all animate-rainbow relative cursor-pointer
         ...
         before:[filter:blur(0.75rem)] border-0"
