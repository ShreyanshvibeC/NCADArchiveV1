    ...
    <div class="max-w-md mx-auto lg:max-w-lg xl:max-w-xl pt-8">
      ...
      <div v-else-if="!authStore.isAuthenticated && isOwnProfile" class="space-y-6">
        ...
        <div class="space-y-4">
          <router-link 
            to="/login"
            class="block w-full bg-ncad-green text-white py-3 font-medium hover:bg-opacity-80 transition-all text-center"
          >
            Sign In
          </router-link>
        ...
        <form @submit.prevent="updateProfile" class="space-y-4">
          ...
          <div class="flex space-x-3">
            <button 
              ...
              class="flex-1 bg-ncad-green text-white py-2 font-medium hover:bg-opacity-80 transition-all disabled:opacity-50"
            >
